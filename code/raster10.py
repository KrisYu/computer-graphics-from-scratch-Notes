#!python
# draw two cubes with transform, clip and z as depth_buffer
#raster-10.py
...
depth_buffer = [[inf for _ in range(screen_height)] for _ in range(screen_width)]
