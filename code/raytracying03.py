...
def traceRay(origin, direction, min_t, max_t):
	...
	return (clamp(r * ComputeLighting(point, normal, -direction, sphere.specular)),
		    clamp(g * ComputeLighting(point, normal, -direction, sphere.specular)),
		    clamp(b * ComputeLighting(point, normal, -direction, sphere.specular)), 255)
