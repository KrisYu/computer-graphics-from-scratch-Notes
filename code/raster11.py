#!python
# draw two cubes with transform, clip and 1/z as depth_buffer
#raster-08.py
...
def renderTriangleUsingPoints(v0, v1, v2, color):
  ...
  iz02, iz012 = edgeInterpolate(y0, z0, y1, z1, y2, z2)

  m = len(x02) // 2
  if x02[m] < x012[m]:
    x_left, x_right = x02, x012
    z_left, z_right = iz02, iz012
  else:
    x_left, x_right = x012, x02
    z_left, z_right = iz012, iz02
